...
describe("GET /cuotas/:id/pagos", () => {
  ...
  it("deberia devolver los pagos de la cuota", async () => {
    const res = await request(app)
      .get(`/cuotas/${cuota.id}/pagos`)
  ...
  it("deberia rechazar peticion sin token", async () => {
    const res = await request(app).get(`/cuotas/${cuota.id}/pagos`);
