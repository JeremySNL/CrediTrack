...
describe("DELETE /prestamos/:id", () => {
  ...
  it("deberia eliminar el prestamo correctamente", async () => {
  ...
  it("deberia rechazar peticion sin token", async () => {
    const res = await request(app).delete(`/prestamos/${prestamo.id}`);
