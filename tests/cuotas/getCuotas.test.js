...
describe("GET /prestamos/:id/cuotas", () => {
  beforeAll(async () => {
  ...
  it("deberia devolver las cuotas del prestamo", async () => {
    const res = await request(app)
      .get(`/prestamos/${prestamo.id}/cuotas`)
  ...
  it("deberia rechazar peticion sin token", async () => {
    const res = await request(app).get(`/prestamos/${prestamo.id}/cuotas`);
